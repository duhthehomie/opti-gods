...
echo    9800X3D + RTX 5070  --  Stream-Safe
echo  ==========================================
echo.
...
# Rig: AMD Ryzen 7 9800X3D | RTX 5070 | 32GB
...
try {
    ...
    Write-Host "[COD] All 16 threads unparked on 9800X3D — no core wake latency during BO6 threading bursts." -ForegroundColor Green
...
try {
    ...
    If ($ryzen) {
        ...
        Write-Host "[COD] AMD Ryzen Balanced power plan activated — correct boost clock behavior for 9800X3D." -ForegroundColor Green
    } Else {
        ...
        Write-Host "[COD] CPU min 0% / max 100% applied — 9800X3D sustains full 5GHz boost during BO6." -ForegroundColor Green
    }
