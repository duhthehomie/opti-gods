...
# Generated: 2026-04-12T03:37:08.902Z
# Tweaks enabled: 283
# ============================================
...
Write-Host "  Starting 283 optimizations..." -ForegroundColor White
...
Write-Host "" 
Write-Host "--- [Registry / System] 116 tweak(s) ---" -ForegroundColor DarkRed
...
Write-Host "" 
Write-Host "--- [FiveM] 36 tweak(s) ---" -ForegroundColor DarkRed
...
try {
    $key = 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\FiveM.exe\PerfOptions'; Set-ItemProperty -Path $key -Name 'IoPriority' -Value 3 -ErrorAction SilentlyContinue
...
try {
    $key = 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\GTA5.exe'; If (!(Test-Path $key)) { New-Item $key -Force }; Set-ItemProperty -Path "$key\PerfOptions" -Name 'WorkingSetLimitInKB' -Value 4194304 -Type DWord
...
Write-Host "" 
Write-Host "--- [Win Tweaks] 26 tweak(s) ---" -ForegroundColor DarkRed
...
Write-Host "=============================================" -ForegroundColor DarkRed
Write-Host "" 
Write-Host "  [OK] $($appliedTweaks.Count) of 283 tweaks applied" -ForegroundColor Green
