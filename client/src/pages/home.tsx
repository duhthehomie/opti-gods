      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="rounded-xl border border-white/5 bg-zinc-950/40 divide-y divide-white/5">
            {[
              { tag: "V2", title: "5-tab dashboard launched", desc: "Home · System Scan · Tweaks · Tools & Fixes · Pro" },
              { tag: "AI", title: "Opti Gods AI now generates presets", desc: "Tell the AI your game and rig — it'll pick your tweaks" },
              { tag: "FIX", title: "FiveM crash fix added to Tools & Fixes", desc: "One-click restore for the streaming crash" },
            ].map(n => (
