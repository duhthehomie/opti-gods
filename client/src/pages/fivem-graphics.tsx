...
const RESHADE_PRESETS = [
  ...
  },
  {
    ...
    desc: "Full cinematic stack: DPX, FilmicSharpen, Vignette, Technicolor2. Best visuals of the four — slight FPS cost. Ideal for recording/screenshots.",
  ...
  },
  {
    ...
    name: "bango_rs",
    label: "Bango RS — Minimal Colour",
    badge: "Lightweight",
    badgeCls: "bg-blue-500/15 border-blue-500/25 text-blue-400",
    desc: "Curves + Technicolor2 + LumaSharpen only — the lightest of the four. Subtle colour correction, almost no performance hit. Best for low-end GPUs.",
