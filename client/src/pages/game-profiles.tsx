...
const PROFILES: GameProfile[] = [
  ...
  { slug: "007-first-light", title: "007: First Light", publisher: "IO Interactive", cover: "/game-covers/007-first-light.jpg", description: "UE5 Engine.ini tuning, Lumen controls, process priority, and shader-cache preparation.", tweakIds: ["game_007firstlight", "CodShaderCacheClear", "CodPagefileOptimize", "CodDisableHAGS", "Cod1650LowLatency", "NvidiaD3DOptimize", "NvidiaPCIeGen3Force", "Cod3500PowerPlan", "CodMemPriority", "CodFramePacing", "CodTdrDelay", "CodMMCSS"] },
