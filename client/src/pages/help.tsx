...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "All downloads are now .bat files — just double-click and click Yes on the UAC popup. No right-click needed, no Unblock step. It handles everything automatically.",
  },
  {
