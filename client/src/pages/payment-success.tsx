          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Payment confirmed. Your Pro access is active — all 411+ tweaks and every game pack are unlocked.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-5 text-left space-y-2">
              {[
                ...
                { text: "411+ system, network, GPU, and memory tweaks", color: "text-red-500" },
