...
const STATS = [
  { icon: Zap, value: "412+", label: "Optimization Tweaks", color: "text-red-400" },
        ...
        <div className="relative overflow-hidden border-b border-white/5 bg-gradient-to-b from-red-950/20 to-transparent px-6 py-10 text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-6 text-xs text-zinc-500">
              <span className="flex items-center gap-1"><Zap className="w-3 h-3 text-red-400" /> 412+ tweaks</span>
