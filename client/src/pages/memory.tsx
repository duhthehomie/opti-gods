...
function getRamProfile(ram: number): RamProfile {
  ...
  if (ram <= 32) return {
    ...
    color: "text-red-400",
    desc: "32GB — Aggressive profile. You can disable the pagefile entirely and eliminate all compression.",
    recommendations: [
      "Disable pagefile entirely — 32GB is enough for any game",
  ...
  return {
    ...
    color: "text-red-400",
    desc: "64GB+ — Maximum aggression. Disable everything pagefile-related and squeeze every last frame.",
    recommendations: [
      "Disable pagefile completely (you'll never page to disk)",
...
const PAGEFILE_TWEAKS: Tweak[] = [
  {
    id: "MemFixedPagefile",
    title: "Set Fixed Pagefile Size (1.5× RAM)",
